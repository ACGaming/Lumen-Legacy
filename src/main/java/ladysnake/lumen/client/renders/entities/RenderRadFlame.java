...
public class RenderRadFlame<T extends Entity> extends Render<T> {

    public RenderRadFlame(RenderManager renderManager) {
        super(renderManager);
        this.shadowOpaque = 0;
    }
    ...
    protected ResourceLocation getEntityTexture(@Nonnull T entity) {
        ...
        return new ResourceLocation(Lumen.MOD_ID, "textures/entities/rad_flame.png");
    }
